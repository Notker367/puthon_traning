...
class DbFixture:
    ...
    def get_group_list(self):
        ...
        try:
            ...
            for row in cursor:
                ...
                list_params.append(Group(id=str(id), name=name, header=header, footer=footer))
        finally:
            cursor.close()
        return list_params
    ...
    def get_contact_list(self):
        ...
        try:
            ...
            for row in cursor:
                ...
                list_params.append(Contact(id=str(id), firstname=firstname, lastname=lastname))
        finally:
            cursor.close()
        return list_params
    ...
    def get_contact_by_id(self, id):
        cursor = self.connection.cursor()
        try:
            cursor.execute(f"select id, firstname, lastname, address, email, email2, email3, home, mobile, work, phone2 from addressbook where id={id}")
